...
SLOTS = [
    ...
    {"slot": "proof-office", "group": "Why travellers trust us", "label": "Office photo",
     "hint": "Photo of your Srinagar office, inside or outside.", "ratio": "16 / 10", "size": "1200 × 750 px", "max_dim": 1400},
    ...
    {"slot": "proof-guest-1", "group": "Why travellers trust us", "label": "Guest photo 1",
     "hint": "Real guest photo — shown in a 3-photo mosaic.", "ratio": "1 / 1", "size": "800 × 800 px", "max_dim": 1000},
